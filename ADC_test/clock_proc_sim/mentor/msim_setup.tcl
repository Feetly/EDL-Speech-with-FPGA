...
# ----------------------------------------
# If clock_proc is one of several IP cores in your
...
# ----------------------------------------
# ACDS 20.1 720 win32 2021.10.08.09:44:39
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/clock_proc.vho"
}
