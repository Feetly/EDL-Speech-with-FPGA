...
# ACDS 20.1 720 win32 2021.09.18.15:13:00
# ----------------------------------------
...
# ----------------------------------------
# If test_pll is one of several IP cores in your
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/test_pll.vho"
}
